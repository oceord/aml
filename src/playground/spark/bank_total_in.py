...
# agg_df = (
#     data_df.groupBy("To_Bank", "To_Account")
#     .agg(sum("Amount_Received").alias("Account_Total_Received"))
#     .groupBy("To_Bank")
#     .agg(sum("Account_Total_Received").alias("Total_Received"))
# )
agg_df = data_df.groupBy("To_Bank").agg(

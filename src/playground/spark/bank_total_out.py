...
# agg_df = (
#     data_df.groupBy("From_Bank", "From_Account")
#     .agg(sum("Amount_Paid").alias("Account_Total_Paid"))
#     .groupBy("From_Bank")
#     .agg(sum("Account_Total_Paid").alias("Total_Paid"))
# )
agg_df = data_df.groupBy("From_Bank").agg(
